...
public class LogIn extends Scene {
    ...
    public Message logIn()
    {
        ...
        jo.put("workId", adminID.getText());
        jo.put("pwd", pwd.getText());
        jo.put("acctype", "admin");
        
        staffID = adminID.getText();
        //log in data
        Message msg = 
                new Message(MessageType.REG,adminID.getText(),
                "db",Base64Utils.encode(jo.toJSONString()), "app");
    ...
    //receive response
    private Message recvRes()
    {
        ByteArrayOutputStream bStream = new ByteArrayOutputStream();
        byte[] buff = new byte[8*1024];//8kb
        
        String EOF;//end of stream
